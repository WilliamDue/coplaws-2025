...
\begin{frame}\frametitle{Perfect Hashing with FKS}
  ...
  \begin{itemize}
    ...
    \item Pick some $h \in H$ from a universal hash family.
    \item<2-> Pick perfect hash functions $h_0, h_1, h_2 \in H$.
  \end{itemize}
  \hfill  
  \end{column}
  \hfill
  \begin{column}{.6\textwidth}
    ...
    \onslide<2->{
      ...
      \begin{array}{|c|M{1cm}{0.4cm}|M{1cm}{0.4cm}|M{1cm}{0.4cm}|}
        ...
        \text{Squared Bin Size} & 4 & 1 & 0 \\ \hline
